...
//data list name, titel, description 
  ...
  //SUPPLIER
	...
	public Map<String,Map<String,String>> getDescriptionСontainers() {
        ...
        descriptionСontainers.put("PROCUREMENT_DOCUMENT", this.getDescriptionСontainer(
                SITE_SHORT_NAME,
        ...
        descriptionСontainers.put("PROCUREMENT_TYPE", this.getDescriptionСontainer(
                SITE_SHORT_NAME,
                NAMESPACE_URI_PROCUREMENT,
                PREFIX_PROCUREMENT,
        ...
        descriptionСontainers.put("LOT_DOCUMENT", this.getDescriptionСontainer(
                SITE_SHORT_NAME,
        ...
        descriptionСontainers.put("LOT_POSITION", this.getDescriptionСontainer(
                SITE_SHORT_NAME,
                NAMESPACE_URI_LOTDOC,
                PREFIX_LOTDOC,
        ...
        descriptionСontainers.put("POSITION", this.getDescriptionСontainer(
                SITE_SHORT_NAME,
                NAMESPACE_URI_LOTDOC,
                PREFIX_LOTDOC,
        ...
        descriptionСontainers.put("QUALIFIER_TYPE", this.getDescriptionСontainer(
                SITE_SHORT_NAME,
                NAMESPACE_URI_LOTDOC,
                PREFIX_LOTDOC,
        ...
        descriptionСontainers.put("DELIVERY_GRAF", this.getDescriptionСontainer(
                SITE_SHORT_NAME,
                NAMESPACE_URI_LOTDOC,
                PREFIX_LOTDOC,
        ...
        descriptionСontainers.put("DELIVERY_SELL_OPT", this.getDescriptionСontainer(
                SITE_SHORT_NAME,
                NAMESPACE_URI_LOTDOC,
                PREFIX_LOTDOC,
        ...
        descriptionСontainers.put("SALE_GRAF", this.getDescriptionСontainer(
                SITE_SHORT_NAME,
                NAMESPACE_URI_LOTDOC,
                PREFIX_LOTDOC,
        ...
        descriptionСontainers.put("SALE_SELL_OPT", this.getDescriptionСontainer(
                SITE_SHORT_NAME,
                NAMESPACE_URI_LOTDOC,
                PREFIX_LOTDOC,
        ...
        descriptionСontainers.put("MANUFACTURER", this.getDescriptionСontainer(
                SITE_SHORT_NAME_DIRECTORIES,
        ...
        descriptionСontainers.put("SAFETY_CLASS", this.getDescriptionСontainer(
                SITE_SHORT_NAME_DIRECTORIES,
                NAMESPACE_URI_DIRECTORY,
                PREFIX_DIRECTORY,
        ...
        descriptionСontainers.put("MATERIALS_LIST", this.getDescriptionСontainer(
                SITE_SHORT_NAME_DIRECTORIES,
                NAMESPACE_URI_DIRECTORY,
                PREFIX_DIRECTORY,
        ...
        descriptionСontainers.put("PAYMENT_CONDITIONS", this.getDescriptionСontainer(
                SITE_SHORT_NAME_DIRECTORIES,
                NAMESPACE_URI_DIRECTORY,
                PREFIX_DIRECTORY,
        ...
        descriptionСontainers.put("PRICE_VALIDITY_IN_TKP", this.getDescriptionСontainer(
                SITE_SHORT_NAME_DIRECTORIES,
                NAMESPACE_URI_DIRECTORY,
                PREFIX_DIRECTORY,
        ...
        descriptionСontainers.put("ICI_SEARCH_RESULTS", this.getDescriptionСontainer(
                SITE_SHORT_NAME,
        ...
        descriptionСontainers.put("CALCULATION_AND_JUSTIFICATION_NMC", this.getDescriptionСontainer(
                SITE_SHORT_NAME,
                NAMESPACE_URI_PRICEINF,
                PREFIX_PRICEINF,
        ...
        descriptionСontainers.put("ATTRIBUTIVE_STRUCTURE_OF_THE_AZTKP_FACILITY", this.getDescriptionСontainer(
                SITE_SHORT_NAME,
                NAMESPACE_URI_AZTKP,
                PREFIX_AZTKP,
