...
/**
 * CustomObjectFinder component.
 * 
 * @namespace Alfresco
 * @class Alfresco.CustomObjectFinder
 */
(function()
{
   /**
   ...
   /**
    * CustomObjectFinder constructor.
    * 
    * @param {String} htmlId The HTML id of the parent element
    * @param {String} currentValueHtmlId The HTML id of the parent element
    * @return {Alfresco.CustomObjectFinder} The new CustomObjectFinder instance
    * @constructor
    */
   Alfresco.CustomObjectFinder = function Alfresco_CustomObjectFinder(htmlId, currentValueHtmlId)
   {
      Alfresco.CustomObjectFinder.superclass.constructor.call(this, "Alfresco.CustomObjectFinder", htmlId, ["button", "menu", "container", "resize", "datasource", "datatable"]);
   ...
   YAHOO.extend(Alfresco.CustomObjectFinder, Alfresco.component.Base,
   {
      /**
       ...
       * @return {Alfresco.CustomObjectFinder} returns 'this' for method chaining
       */
      setOptions: function CustomObjectFinder_setOptions(obj)
      {
         Alfresco.CustomObjectFinder.superclass.setOptions.call(this, obj);
       ...
       * @return {Alfresco.CustomObjectFinder} returns 'this' for method chaining
       */
      setMessages: function CustomObjectFinder_setMessages(obj)
      {
         Alfresco.CustomObjectFinder.superclass.setMessages.call(this, obj);
       ...
       */
      selectItems: function CustomObjectFinder_selectItems(items)
      {
       ...
       * @method onReady
       */
      onReady: function CustomObjectFinder_onReady()
      {
       ...
       * @method destroy
       */
      destroy: function CustomObjectFinder_destroy()
      {
         try
         {
         ...
         Alfresco.CustomObjectFinder.superclass.destroy.call(this);
      },
       ...
       */
      onAddButtonClick: function CustomObjectFinder_onAddButtonClick(e, p_obj)
      {
         ...
         if (!this.widgets.escapeListener)
         {
            ...
            {
               fn: function CustomObjectFinder_onAddButtonClick_fn(eventName, keyEvent)
               {
                  this.onCancel();
       ...
       * @param p_obj {object} Object passed back from addListener method
       */
      onRemoveAllButtonClick: function CustomObjectFinder_onRemoveAllButtonClick(e, p_obj)
      {
       ...
       * @param p_obj {object} Object passed back from addListener method
       */
      onFolderUp: function CustomObjectFinder_onFolderUp(e, p_obj)
      {
       ...
       * @param p_obj {object} Object passed back from addListener method
       */
      onCreateNewOK: function CustomObjectFinder_onCreateNewOK(e, p_obj)
      {
         Event.preventDefault(e);
      },
       ...
       * @param p_obj {object} Object passed back from addListener method
       */
      onCreateNewCancel: function CustomObjectFinder_onCreateNewCancel(e, p_obj)
      {
         Event.preventDefault(e);
      },
       ...
       * @param p_obj {object} Object passed back from addListener method
       */
      onOK: function CustomObjectFinder_onOK(e, p_obj)
      {
       ...
       * @param p_obj {object} Object passed back from addListener method
       */
      onCancel: function CustomObjectFinder_onCancel(e, p_obj)
      {
         this.widgets.escapeListener.disable();
         this.widgets.dialog.hide();
         this.widgets.addButton.set("disabled", false);
       ...
       * @method onSearch
       */
      onSearch: function CustomObjectFinder_onSearch()
      {
       ...
       * @return {boolean}
       */
      canItemBeSelected: function CustomObjectFinder_canItemBeSelected(id)
      {
       ...
       * @return {array}
       */
      getSelectedItems: function CustomObjectFinder_getSelectedItems()
      {
         var selectedItems = [];
       ...
       * @return {array}
       */
      getAddedItems: function CustomObjectFinder_getAddedItems()
      {
         var addedItems = [],
       ...
       * @return {array}
       */
      getRemovedItems: function CustomObjectFinder_getRemovedItems()
      {
         var removedItems = [],
            currentItems = Alfresco.util.arrayToObject(this.options.currentValue.split(","));
       ...
       */
      onSelectedItemAdded: function CustomObjectFinder_onSelectedItemAdded(layer, args)
      {
         // Check the event is directed towards this instance
         if ($hasEventInterest(this, args))
         {
       ...
       * @param args {array} Event parameters (depends on event type)
       */
      onSelectedItemRemoved: function CustomObjectFinder_onSelectedItemRemoved(layer, args)
      {
         // Check the event is directed towards this instance
         if ($hasEventInterest(this, args))
         {
       ...
       * @param args {array} Event parameters (depends on event type)
       */
      onParentChanged: function CustomObjectFinder_onParentChanged(layer, args)
      {
         // Check the event is directed towards this instance
         if ($hasEventInterest(this, args))
         {
       ...
       * @param args {array} Event parameters (depends on event type)
       */
      onParentDetails: function CustomObjectFinder_onParentDetails(layer, args)
      {
         // Check the event is directed towards this instance
         if ($hasEventInterest(this, args))
         {
       ...
       * @param args {array} Event parameters
       */
      onFormContainerDestroyed: function CustomObjectFinder_onFormContainerDestroyed(layer, args)
      {
       ...
       * @param args {array} Event parameters
       */
      onRemoveListItem: function CustomObjectFinder_onRemoveListItem(event, args)
      {
         if ($hasEventInterest(this, args))
         {
       ...
       */
      fnRenderCellIcon: function CustomObjectFinder_fnRenderCellIcon()
      {
         var scope = this;
          ...
          */
         return function CustomObjectFinder_renderCellIcon(elCell, oRecord, oColumn, oData)
         {
       ...
       */
      fnRenderCellGenericIcon: function CustomObjectFinder_fnRenderCellGenericIcon()
      {
         var scope = this;
          ...
          * @param oData {object|string}
          */
         return function CustomObjectFinder_renderCellGenericIcon(elCell, oRecord, oColumn, oData)
         {
            Alfresco.logger.debug("CustomObjectFinder_renderCellGenericIcon(" + elCell + ", " + oRecord + ", " + oColumn.width + ", " + oData + ")");
            var iconSize = scope.options.compactMode ? 16 : 32;
            if (oColumn.width)
            {
               Alfresco.logger.debug("CustomObjectFinder_renderCellGenericIcon setting width!");
       ...
       */
      fnRenderCellName: function CustomObjectFinder_fnRenderCellName()
      {
         var scope = this;
          ...
          * @param oData {object|string}
          */
         return function CustomObjectFinder_renderCellName(elCell, oRecord, oColumn, oData)
         {
            var template;
       ...
       */
      fnRenderCellRemove: function CustomObjectFinder_fnRenderCellRemove()
      {
         var scope = this;
          ...
          * @param oData {object|string}
          */
         return function CustomObjectFinder_renderCellRemove(elCell, oRecord, oColumn, oData)
         {
            Dom.setStyle(elCell.parentNode, "width", oColumn.width + "px");
       ...
       */
      fnRenderCellListItemName: function CustomObjectFinder_fnRenderCellListItemName()
      {
         var scope = this;
          ...
          * @param oData {object|string}
          */
         return function CustomObjectFinder_fnRenderCellListItemName(elCell, oRecord, oColumn, oData)
         {
       ...
       */
      fnRenderCellListItemActions: function CustomObjectFinder_fnRenderCellListItemActions()
      {
         var scope = this;
          ...
          * @param oData {object|string}
          */
         return function CustomObjectFinder_fnRenderCellListItemActions(elCell, oRecord, oColumn, oData)
         {
            if (oColumn.width)
            {
               Dom.setStyle(elCell, "width", oColumn.width + (YAHOO.lang.isNumber(oColumn.width) ? "px" : ""));
       ...
       * @private
       */
      _loadSelectedItems: function CustomObjectFinder__loadSelectedItems(useOptions)
      {
         var arrItems = "";
       ...
       * @private
       */
      _createNavigationControls: function CustomObjectFinder__createNavigationControls()
      {
         var me = this;
       ...
       * @private
       */
      _createSelectedItemsControls: function CustomObjectFinder__createSelectedItemsControls()
      {
         var doBeforeParseDataFunction = function CustomObjectFinder__createSelectedItemsControls_doBeforeParseData(oRequest, oFullResponse)
         {
         ...
         if (this.options.disabled === false)
         {
            ...
            var fnRemoveItemHandler = function CustomObjectFinder__createSelectedItemsControls_fnRemoveItemHandler(layer, args)
            {
         ...
         if (this.options.displayMode == "list")
         {
            ...
            var fnActionListItemHandler = function CustomObjectFinder__createSelectedItemsControls_fnActionListItemHandler(layer, args)
            {
               var owner = YAHOO.Bubbling.getOwnerByTagName(args[1].anchor, "div");
               if (owner !== null)
               {
       ...
       * @private
       */
      _populateSelectedItems: function CustomObjectFinder__populateSelectedItems()
      {
         // Empty results table
       ...
       * @private
       */
      _resolveStartLocation: function CustomObjectFinder__resolveStartLocation()
      {
       ...
       * @private
       */
      _locateStartingNode: function CustomObjectFinder__locateStartingNode()
      {
         if (this.options.startLocation && this.options.currentItem && this.options.currentItem !== null)
         {
            ...
            var successHandler = function CustomObjectFinder__locateStartingNode_successHandler(response)
            {
            ...
            var failureHandler = function CustomObjectFinder__locateStartingNode_failureHandler(response)
            {
               if (Alfresco.logger.isDebugEnabled())
               {
       ...
       * @private
       */
      _fireRefreshEvent: function CustomObjectFinder__fireRefreshEvent()
      {
       ...
       * @private
       */
      _createResizer: function CustomObjectFinder__createResizer()
      {
         if (!this.widgets.resizer)
         {
       ...
       * @private
       */
      _inAuthorityMode: function CustomObjectFinder__inAuthorityMode()
      {
       ...
       * @private
       */
      _enableActions: function CustomObjectFinder__enableActions()
      {
         ...
         {
            this.isReady = true;
            YAHOO.Bubbling.fire("CustomObjectFinderReady",
            {
               eventGroup: this
            });
         }
...
(function()
{
    ...
    * 
    * @param {object} Instance of the CustomObjectFinder
    * @return {Alfresco.ObjectRenderer} The new ObjectRenderer instance
    * @constructor
    */
   Alfresco.ObjectRenderer = function(CustomObjectFinder)
   {
      this.CustomObjectFinder = CustomObjectFinder;
      
      Alfresco.ObjectRenderer.superclass.constructor.call(this, "Alfresco.ObjectRenderer", CustomObjectFinder.pickerId, ["button", "menu", "container", "datasource", "datatable"]);
      /**
       * Decoupled event listeners
       */
      this.eventGroup = CustomObjectFinder.eventGroup;
   ...
   YAHOO.extend(Alfresco.ObjectRenderer, Alfresco.component.Base,
   {
      ...
      {
         this.addItemButtons = {};
         Dom.get(this.CustomObjectFinder.pickerId).focus();
      },
            ...
            if (obj && obj.item)
            {
               ...
               for (var id in this.addItemButtons)
               {
                  if (this.addItemButtons.hasOwnProperty(id))
                  {
                     ...
                     Dom.setStyle(button, "display", this.CustomObjectFinder.canItemBeSelected(id) ? "inline" : "none");
                  }
               }
            }
         }
      ...
      fnRenderCellAdd: function ObjectRenderer_fnRenderCellAdd()
      {
         ...
         return function ObjectRenderer_renderCellAdd(elCell, oRecord, oColumn, oData)
         {
            ...
            if (oRecord.getData("selectable"))
            {
               ...
               if (!scope.CustomObjectFinder.canItemBeSelected(nodeRef))
               {
      ...
      _generatePickerChildrenUrlParams: function ObjectRenderer__generatePickerChildrenUrlParams(searchTerm)
      {
         ...
         if (!this.startLocationResolved && this.CustomObjectFinder.options.startLocation &&
              this.CustomObjectFinder.options.startLocation.charAt(0) == "/")
         {
            params += "&xpath=" + encodeURIComponent(this.CustomObjectFinder.options.startLocation);
         }
         
         // has a rootNode been specified?
         if (this.CustomObjectFinder.options.rootNode)
         {
            var rootNode = null;

            if (this.CustomObjectFinder.options.rootNode.charAt(0) == "{")
            {
               if (this.CustomObjectFinder.options.rootNode == "{companyhome}")
               {
                  rootNode = "alfresco://company/home";
               }
               else if (this.CustomObjectFinder.options.rootNode == "{userhome}")
               {
                  rootNode = "alfresco://user/home";
               }
               else if (this.CustomObjectFinder.options.rootNode == "{siteshome}")
               {
            ...
            else
            {
               ...
               rootNode = this.CustomObjectFinder.options.rootNode;
            }
            if (rootNode !== null)
            {
         ...
         if(this.CustomObjectFinder.options.selectableMimeType)
         {
            params += "&selectableMimeType=" + encodeURI(this.CustomObjectFinder.options.selectableMimeType);
         }

         if (this.CustomObjectFinder.options.params)
         {
            params += "&" + encodeURI(this.CustomObjectFinder.options.params);
         }
